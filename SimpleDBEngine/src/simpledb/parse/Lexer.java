...
//   }
	...
	public boolean matchKeyword(String w) {
		return tok.ttype == StreamTokenizer.TT_WORD && keywords.contains(w) && tok.sval.equals(w);
	}
	...
	public boolean matchAggType() {
		return tok.ttype == StreamTokenizer.TT_WORD && aggType.contains(tok.sval);
	}
...
//   }
	...
	/**
	 * Throws an exception if the current token is not the specified equality
	 * keyword. Otherwise, moves to the next token.
	 * 
	 * @param w the keyword string
	...
	/**
	 * Throws an exception if the current token is not the specified index type.
	 * Otherwise, moves to the next token.
	 * 
	 * @param w the keyword string
	 * @return the string value of the equality token
	...
	/**
	 * Throws an exception if the current token is not a sort type. Otherwise,
	 * returns the sort type boolean and moves to the next token.
	 * 
	 * @return the string value of the current token
	 */
	...
	/**
	 * Throws an exception if the current token is not the terminal token.
	 */
	public void eatEnd() {
		if (!matchEnd())
			throw new BadSyntaxException();
	...
	/**
	 * Throws an exception if the current token is not an aggregate type. Otherwise,
	 * returns the aggregate type string and moves to the next token.
	 * 
	 * @return the string value of the current token
	 */
	...
	/**
	 * Throws an exception if the current token is not an aggregate field.
	 * Otherwise, returns the aggregate field string and moves to the next token.
	 * 
	 * @return the string value of the current token
	 */
	...
	private void initKeywords() {
		keywords = Arrays.asList("select", "distinct", "from", "where", "and", "insert", "into", "values", "delete",
				"update", "set", "create", "table", "int", "varchar", "float", "view", "as", "index", "using", "on",
				"order", "group", "by", "distinct", "indexjoin", "mergejoin", "nestedjoin", "hashjoin");
	}
