...
public class HashJoinPlan implements Plan {
	 ...
	 */
	public HashJoinPlan(Transaction tx, Plan p1, Plan p2, String fldname1, String fldname2, String opr, int numPart) {
		this.tx = tx;
		this.p1 = p1;
		this.p2 = p2;
	...
	public Scan open() {
		...
		Scan s2 = p2.open();
		printPlan();
		return new HashJoinScan(s1, s2, fldname1, fldname2, opr, numPart);
	}
